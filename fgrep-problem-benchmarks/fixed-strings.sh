...
update-re2c-keywords() {
  local pat="$(re2c-pat)"
  sed -i "s;.*__TO_REPLACE__.*;      $pat  // __TO_REPLACE__ ;g" demo/fixed-strings.re2c.cc
}
...
re2c-fixed-benchmark() {
  ...
  re2c -o $gen demo/fixed-strings.re2c.cc
...
viz() {
  ...
  re2c --emit-dot -o $dot demo/$name.re2c.cc
...
# - Benchmark against Python, a backtracking engine.  Can it do things "in
# parallel"?  Could also do Perl.
#
# - Move this to a different repo.
#
